...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 w-11/12 mx-auto pb-12' data-aos="fade-up" data-aos-offset="0" data-aos-anchor-placement="top-bottom">
        {
